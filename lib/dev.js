...
var webpackLoaders = require('./devConfig/webpack.loaders.js');
var webpackFeatures = require('./devConfig/webpack.features.js');
...
function getWebpackCompiler(devMode) {
  return pfs
    ...
    .then(function(pkg) {
      var umdConf = require(path.resolve(__dirname, '/devConfig/webpack.config.umd.js'));
    //   var umdConf = require(cx.__plugin_dir + '/devConfig/webpack.config.umd.js');
      umdConf.pkg = pkg;
