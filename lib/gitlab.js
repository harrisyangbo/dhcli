...
DhGitlab.prototype.inputUserInfo = function() {
    return form([{
        message: 'Gitlab url:',
        type: 'input',
        name: 'gitlabURL',
...
DhGitlab.prototype.getProjects = function() {
    // 获取所有项目
    let _self = this
    request({
...
DhGitlab.prototype.createPro =function() {
    let _self = this
...
DhGitlab.prototype.createHooks = function() {
    let _self = this
